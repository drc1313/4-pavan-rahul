...
# z score
        ...
        if len(projectcount) <= 5:
            projectlist.append({"project_id":project_id,"project_title":project_title,"judge_details":rawscore_judgelist,"project_category":project_category,"description":description,"total_score":totalscore,"average_score":average_score,"z_score":zscoreresult})
    ...
    if not assignmentcheck:
        ...
        for assignrank in projectlist:
                    ...
                    assignrank["scaled_score"]="Null"
                    assignrank["average_rank"]="Null"
                    assignrank["rawscore_rank"]="Null"
                    assignrank["scaled_rank"]="Null"
                    assignrank["scaled_zscore"]="Null"
                    assignrank["isef_score"]="Null"
                    assignrank["iself_rank"]="Null"
